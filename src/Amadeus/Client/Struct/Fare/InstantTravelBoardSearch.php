...
use Amadeus\Client\RequestOptions\FareInstantTbSearch;
 ...
 */
class InstantTravelBoardSearch extends BaseMasterPricerMessage
{
    /**
     * @var mixed
     */
     ...
     *
     * @param FareInstantTbSearch|FareMasterPricerCalendarOptions|TicketAtcShopperMpTbSearchOptions|null $options
     */
    public function __construct($options = null)
    {
        if ($options instanceof FareInstantTbSearch) {
            $this->loadOptions($options);
        }
    }

    /**
     * @param FareInstantTbSearch|FareMasterPricerCalendarOptions|TicketAtcShopperMpTbSearchOptions $options
     */
